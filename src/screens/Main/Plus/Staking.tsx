    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      >
        ...
        <Text weight="bold" mt={10}>
          Per effettuare lo staking di ZeroOne è sufficiente avere token in
          deposito nel proprio wallet. Lo staking avviene in automatico nel
          proprio wallet. Lo staking ZeroOne è esclusiva di ATS seguendo
          l'apposita procedura indicata sul sito.
        </Text>
      ...
      >
        <Text color="white" weight="bold" size={'tiny'}>
          INSERISCI L&APOS;IMPORTO DA SBLOCCARE DALLO STAKING
        </Text>
        <View style={[Layout.rowHCenter, styles.stakingInputContainer]}>
          <TextInput style={styles.stakingInput} />
          <TouchableOpacity style={{ width: 60 }}>
        ...
        <View style={[Layout.alignItemsEnd, Gutters.tinyTMargin]}>
          <Text size="tiny">Quantità di token in stake:1,000.00 ZONE</Text>
        </View>
      ...
      <View style={[Layout.alignItemsCenter, Gutters.smallVMargin]}>
        <Image source={Images.main.bigCoinWithShadow} />
      </View>
    </ScrollView>
  );
};
