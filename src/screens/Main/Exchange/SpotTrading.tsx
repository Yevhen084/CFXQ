...
const SpotTrading = () => {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[Gutters.regularBPadding]}>
      <TouchableOpacity
      ...
      <View style={[Layout.fill, Gutters.smallTMargin]}>
        <View style={[Layout.rowHCenter, Layout.justifyContentBetween, Gutters.smallBPadding, { borderBottomWidth: 1, borderBottomColor: Colors.borderColor }]}>
