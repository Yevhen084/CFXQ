...
std::shared_ptr<TurboModule> rncli_ModuleProvider(const std::string moduleName, const JavaTurboModule::InitParams &params) {
  auto module_AmplifyRTNCore = AmplifyRTNCore_ModuleProvider(moduleName, params);
  if (module_AmplifyRTNCore != nullptr) {
    return module_AmplifyRTNCore;
  }
